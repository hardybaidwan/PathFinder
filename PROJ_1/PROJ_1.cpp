...
void frontscreen(void)
{
    ...
    glColor3f(1, 1, 1);
    output(5, 160, "Thapar Institute of Engineering and Technology");
    glColor3f(1, 1, 1);
    output(10.0, 150, "DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING");
    glColor3f(1, 0, 1);
    output(60, 130, "Project On:-");
    glColor3f(0, 1, 0.5);
    output(38, 120, "\"PathFinding Puzzle\"");
    glColor3f(1, 0, 1);
    output(40, 100, "By :");
    glBegin(GL_LINES);
    glVertex2f(40, 98);
    ...
    glEnd();
    glColor3f(1, 0, 0);
    output(40, 90, "Brijeshwar Singh(101803170) ");
    output(40, 80, "Tajeshwar Singh(101803171) ");
